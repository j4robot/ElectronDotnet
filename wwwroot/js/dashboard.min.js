    ...
    if ($("#world-map").length !== 0) {
        $("#world-map").vectorMap({
            ...
            markers: [
                ...
                { latLsng: [47.14, 9.52], name: "Liechtenstein" },
...
var handleInteractiveChart = function() {
    ...
    function e(e, t, n) { $('<div id="tooltip" class="flot-tooltip">' + n + "</div>").css({ top: t - 45, left: e - 55 }).appendTo("body").fadeIn(200) }
...
var handleDashboardSparkline = function() {
    ...
    function t() {
        ...
        if (n >= 200) { e.width = "200px" } else { e.width = "100%" }
...
var handleDashboardTodolist = function() {
    "use strict";
    $("[data-click=todolist]").click(function() { var e = $(this).closest("li"); if ($(e).hasClass("active")) { $(e).removeClass("active") } else { $(e).addClass("active") } })
};
var handleDashboardGritterNotification = function() {
    //$(window).load(function () {
    //    setTimeout(function () {
    //        $.gritter.add({ title: "Welcome back, HCM Admin!", text: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempus lacus ut lectus rutrum placerat.", image: "../img/user-2.jpg", sticky: true, time: "", class_name: "my-sticky-class" })
    //    }, 1e3)
    //})
};
